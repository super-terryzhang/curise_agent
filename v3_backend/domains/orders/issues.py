...
_RESOLUTIONS: dict[str, tuple[str, str]] = {
    ...
    "UNIT_CONVERSION_RULE_STALE": ("unit_conversion", "重新确认商品包装"),
    "UNIT_CONVERSION_RULE_CONFLICT": ("unit_conversion", "处理冲突换算规则"),
    "NON_INTEGER_PACKAGE_QUANTITY": ("unit_conversion", "确认订购步长"),
    "UNIT_CONVERSION_EVALUATION_FAILED": ("unit_conversion", "重新检查或人工处理"),
